  ...
  return (
    <Section className="flex max-md:flex-col items-center">
      <div className="flex-[3] flex-col gap-2">
        ...
        <h3 className="text-3xl font-caption">Application developer</h3>
        <p>
          Hi! I m Alhassane Diallo a application developer based in Tours,
          French. I specialize in building websites and web applications using
          modern technologies like <Code>html</Code>, <Code>css</Code>,
          <Code>Scss</Code>, <Code> Tailwind CSS </Code>,<Code>JavaScript</Code>
          , <Code>React</Code>, <Code>Next.js</Code>, <Code>NodeJS</Code>,
          <Code>ExpressJS</Code>, <Code>SQL</Code>, <Code>MySql</Code>,
          <Code>Angular</Code>, <Code>TypeScript</Code>, <Code>Java</Code>,
          <Code>Spring Boot</Code>,<Code>Docker</Code>, <Code>CI/CD</Code>,{" "}
